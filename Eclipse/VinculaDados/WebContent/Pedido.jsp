        ...
        <form method="POST" action='PedidoBll' name="frmDadosPedido">
            <table>
                <tbody>
                    <tr>
                        <td>Numero:</td>
                        <td> <input type="text" readonly="readonly" name="numero" value="<c:out value="${pedido.numero}" />" /> </td> 
                    </tr>
                    <tr>
                        <td>Data:</td>
                        <td> <input type="text" name="data" value="<fmt:formatDate pattern="MM/dd/yyyy" value="${pedido.data}" />" /> </td> 
                    </tr>
                    <tr>
                        <td>Cliente:</td>
                        <td> 
